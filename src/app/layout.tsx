  ...
  return (
    <html lang="en">
      <body
        ...
        style={{backgroundColor: '#2e0202ff', color: '#e9ecf7'}}
      >
        <div style={{ minHeight: '100vh', display: 'flex', flexDirection: 'column', padding: '1em' }}>
          <header style={{ marginBottom: '2em', padding: '1.5em', background: '#b8b8b8ff', color: '#e9ecf7', borderRadius: '.5em', boxShadow: '0 6px 18px #0004' }}>
            <h1 style={{ fontSize: '30px', textAlign: 'center', margin: 0, fontWeight: 650, color: '#000' }}>Gerenciador de tarefas</h1>
          </header>
          <main style={{ flex: 1, padding: '1.5em', borderRadius: '.5em', color: '#e9ecf7' }}>{children}</main>
          <footer style={{ marginTop: '2em', padding: '1.5em', background: '#b8b8b8ff', color: '#000', borderRadius: '.5em', fontSize: '14px', boxShadow: '0 6px 18px #0004' }}>
